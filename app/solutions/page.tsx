        ...
        <main>
            ...
            <section style={{
                ...
                <div className="container animate-fade">
                    <h1 className="hero-title" style={{ fontWeight: 800, color: 'white' }}>Custom Solutions for <br />Every Institution</h1>
            ...
            <section className="container section">
                {[
                    ...
                    <div key={i} className="grid grid-2" style={{
                        ...
                        <div style={{ order: sol.reverse ? 2 : 1 }} className="animate-fade">
                            <h2 style={{ fontSize: 'clamp(32px, 5vw, 40px)', marginBottom: '24px' }}>{sol.title}</h2>
                            <p style={{ fontSize: '18px', color: 'var(--text-muted)', lineHeight: '1.7', marginBottom: '32px' }}>{sol.desc}</p>
                            <button className="btn btn-outline" style={{ padding: '12px 32px' }}>Learn More</button>
                        </div>
                        <div style={{
