        ...
        <div style={{ background: 'white' }}>
            ...
            <section style={{ padding: '160px 0 100px', background: '#046B63', color: 'white', position: 'relative', overflow: 'hidden' }}>
                ...
                <div className="container animate-slide-up" style={{ textAlign: 'center', maxWidth: '800px', position: 'relative', zIndex: 1 }}>
                    <div style={{ background: '#FF7D00', color: 'white', padding: '8px 20px', borderRadius: '30px', fontSize: '11px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '2px', display: 'inline-block', marginBottom: '32px', fontFamily: 'var(--font-orbitron)', boxShadow: '0 4px 12px rgba(255,125,0,0.3)' }}>Who We Are</div>
                    <h1 style={{ fontSize: 'clamp(40px, 6vw, 68px)', fontWeight: 900, fontFamily: 'var(--font-orbitron)', marginBottom: '28px', lineHeight: 1.1 }}>
                        We are builders of the <span style={{ color: '#FF7D00' }}>future of learning</span>.
                    </h1>
                    <p className="animate-fade delay-2" style={{ fontSize: '20px', opacity: 0.8, lineHeight: 1.7, maxWidth: '700px', margin: '0 auto' }}>
                ...
                <div className="container">
                    <div className="grid grid-4" style={{ gap: '32px', textAlign: 'center' }}>
                        {[
                            ...
                            { val: '43%', label: 'Female Leadership' },
                            { val: '14+', label: 'Countries Served' },
                            { val: '$12M', label: 'Series A Raised' }
                        ].map((s, i) => (
                            <div key={i} className={`animate-slide-up delay-${(i % 4) + 1}`}>
                                <div style={{ fontSize: 'clamp(36px, 4vw, 52px)', fontWeight: 900, color: '#FF7D00', fontFamily: 'var(--font-orbitron)', marginBottom: '8px' }}>{s.val}</div>
                                <div style={{ fontSize: '12px', color: 'rgba(255,255,255,0.4)', fontWeight: 800, textTransform: 'uppercase', letterSpacing: '1px' }}>{s.label}</div>
                            </div>
                        ))}
                    </div>
                </div>
                ...
                <div className="container">
                    <div className="grid grid-2" style={{ gap: '80px', alignItems: 'center' }}>
                        <div className="animate-slide-left">
                            <div style={{ background: '#FFF7ED', color: '#FF7D00', padding: '8px 20px', borderRadius: '30px', fontSize: '12px', fontWeight: 900, textTransform: 'uppercase', letterSpacing: '2px', display: 'inline-block', marginBottom: '28px', fontFamily: 'var(--font-orbitron)' }}>Our Mission</div>
                            <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 900, fontFamily: 'var(--font-orbitron)', color: 'var(--secondary)', marginBottom: '24px' }}>
                        ...
                        <div className="animate-slide-right delay-2" style={{ position: 'relative' }}>
                            ...
                            />
                            <div className="animate-bounce-in delay-4" style={{
                                position: 'absolute', bottom: '-24px', left: '24px',
                                background: '#005B52', color: 'white', padding: '24px 32px',
                                borderRadius: '20px', boxShadow: '0 12px 32px rgba(0,0,0,0.15)'
                            }}>
                                <div style={{ fontSize: '32px', fontWeight: 900, fontFamily: 'var(--font-orbitron)' }}>A+</div>
            ...
            <section style={{ padding: '80px 0 120px', background: '#F8FAFC' }}>
                <div className="container animate-slide-up" style={{ textAlign: 'center', maxWidth: '700px' }}>
                    <h2 style={{ fontSize: 'clamp(28px, 4vw, 44px)', fontWeight: 900, fontFamily: 'var(--font-orbitron)', color: 'var(--secondary)', marginBottom: '20px' }}>
